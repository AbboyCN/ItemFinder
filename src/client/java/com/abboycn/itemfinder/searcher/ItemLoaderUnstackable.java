...
public class ItemLoaderUnstackable {
    ...
    public static class ItemCategory {
        ...
        public ItemCategory(List<String> itemIds, BlockPos position) {
    ...
    public static List<ItemCategory> getAllZones() {
        return Collections.unmodifiableList(LOADED_Categories);
    }
}
